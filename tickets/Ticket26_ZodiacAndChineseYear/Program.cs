...
namespace Ticket26_ZodiacAndChineseYear
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Write("Введите свою дату рождения (например, 30 января): ");
        ...
        {
            string[] animals = {
                "Обезьяна", "Петух", "Собака", "Свинья", "Мышь", "Бык",
                "Тигр", "Кролик", "Дракон", "Змея", "Лошадь", "Овца"
            };

            int index = year % 12; // Индекс животного по циклу
